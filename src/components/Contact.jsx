        ...
        <div className="relative bg-white py-12">
          <div className="container mx-auto px-4">
            <div className="text-center mb-8">
              <h2 className="text-4xl font-bold text-[#3270DF] mb-4 relative inline-block">
                OUR GLOBAL PRESENCE
                <span className="absolute bottom-[-8px] left-1/2 transform -translate-x-1/2 w-16 h-1 bg-[#3270DF]"></span>
              </h2>
        ...
        <div className="flex flex-col md:flex-row bg-white rounded-lg shadow-md overflow-hidden p-8 gap-8 container mx-auto">
          ...
          <div className="md:w-1/2 w-full">
            ...
            <form className="space-y-4">
              ...
              <button className="w-full bg-[#3270DF] text-white p-3 rounded  focus:outline-none focus:ring-2 focus:ring-blue-400">
                Send Message
              </button>
            </form>
          </div>
